...
class MockNotificationService implements NotificationServiceBase {
  ...
  ({bool enabled, int hour, int minute}) _settings =
...
void main() {
  group('SettingsScreen - Notification Preferences', () {
    ...
    group('AC: Notification toggle control', () {
      testWidgets(
          'displays a Switch widget for enabling/disabling notifications',
      ...
      testWidgets('loadSettings is called on screen initialization',
        ...
        expect(
          mockService.loadSettingsCalled,
          isTrue,
      ...
      testWidgets('toggling Switch ON calls scheduleDailyNotification',
        ...
        expect(
          mockService.scheduleDailyNotificationCalled,
          isTrue,
      ...
      testWidgets('toggling Switch OFF calls cancelNotification',
        ...
        expect(
          mockService.cancelNotificationCalled,
          isTrue,
    ...
    group('AC: Time selection control', () {
      ...
      testWidgets('has a tappable element for changing notification time',
        ...
        final tappable = find.ancestor(
          ...
          matching: find.byWidgetPredicate(
            (w) => w is ListTile || w is InkWell || w is GestureDetector,
          ),
        );
        expect(
          tappable,
      ...
      testWidgets(
          'confirming new time calls scheduleDailyNotification with new values',
          (WidgetTester tester) async {
    ...
    group('AC: Settings persistence across sessions', () {
      ...
      testWidgets(
          'enabled state persists (simulated by re-reading from service)',
          (WidgetTester tester) async {
      ...
      testWidgets(
          'disabled state persists (simulated by re-reading from service)',
          (WidgetTester tester) async {
    ...
    group('Edge case: Idempotent operations', () {
      testWidgets(
          'toggling ON when already enabled calls scheduleDailyNotification',
          (WidgetTester tester) async {
        // Arrange: start enabled
